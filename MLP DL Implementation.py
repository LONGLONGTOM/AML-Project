...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 18 13:54:31 2023
...
INPUT_DIR = "/Users/Dogar/Desktop/Columbia Material/Spring 2023/AML/Group Project/Data/pubg-finish-placement-prediction/"
...
# Split the dataset into 80% and 20% portions
data_80_percent = df[:split_index]
data_20_percent = df[split_index:]
y_test_final = data_20_percent['winPlacePerc']
...
# Scale the target to be in range (-1,1)
y = y * 2 - 1
...
# Processing the test data and scale it
...
# Now calculating metrics: accuracy, mse, and mae
from sklearn.metrics import mean_absolute_error, mean_squared_error, r2_score

# Calculate r2, MAE, and MSE
mae = mean_absolute_error(y_test_final, pred)
